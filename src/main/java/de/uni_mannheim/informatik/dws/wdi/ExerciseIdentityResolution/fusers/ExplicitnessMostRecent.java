 ...
 */
public class ExplicitnessMostRecent extends AttributeValueFuser<String, Song, Attribute> {

	public ExplicitnessMostRecent() {
		super(new MostRecent<String, Song, Attribute>());
	}
