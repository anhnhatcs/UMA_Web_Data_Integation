 ...
 */
public class AlbumYearFuserVoting extends AttributeValueFuser<Integer, Song, Attribute> {

	public AlbumYearFuserVoting() {
		super(new Voting<Integer, Song, Attribute>());
	}
	...
	public void fuse(RecordGroup<Song, Attribute> group, Song fusedRecord, Processable<Correspondence<Attribute, Matchable>> schemaCorrespondences, Attribute schemaElement) {
		...
		fusedRecord.setAttributeProvenance(Song.ALBUM_YEAR, fused.getOriginalIds());
	}
