 ...
 * {@link Comparator} for {@link Song}s based on {@link Song#getAlbum()} values.
 * Created by Shamalan Rajesvaran
 * @version 1.2
 */
public class SongAlbumComparatorJaroWinkler implements Comparator<Song, Attribute> {
    ...
    public double compare(
        ...
        double similarityScore = similarity.calculate(album1, album2);
