 ...
 */
public class ExplicitnessFavourSource extends AttributeValueFuser<String, Song, Attribute> {

	public ExplicitnessFavourSource() {
	...
	public void fuse(RecordGroup<Song, Attribute> group, Song fusedRecord, Processable<Correspondence<Attribute, Matchable>> schemaCorrespondences, Attribute schemaElement) {
		...
		fusedRecord.setAttributeProvenance(Song.TRACK_EXPLICITNESS,
