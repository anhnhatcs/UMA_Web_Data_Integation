...
public class SongDurationComparator10Seconds implements Comparator<Song, Attribute> {
    private static final long serialVersionUID = 1L;
    private ComparatorLogger comparisonLog;
    private AbsoluteDifferenceSimilarity sim = new AbsoluteDifferenceSimilarity(10000); //compare durations with max 10 seconds diff
