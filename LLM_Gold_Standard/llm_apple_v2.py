...
class MusicMatcher:
    ...
    def compare_tracks(self, row: Dict) -> Dict:
        try:
            ...
            5. If the music have name with some suffix but perform by different artist or in different album song, they will be mark as not same. For example: "This Is What You Came For" and "This Is What You Came For (Bobby Puma Remix)"
...
if __name__ == "__main__":
    # Test file path
    file_path = "/Users/anhnhat/Library/Mobile Documents/com~apple~CloudDocs/Documents/UNIMA/2. Semester Study/2. WS2425/4. W24 Web Data Integration/Project/v2/UMA_Web_Data_Integation/LLM_Gold_Standard/output/apple_merged.csv"
    ...
    # Save all results
    matcher.save_results( "/Users/anhnhat/Library/Mobile Documents/com~apple~CloudDocs/Documents/UNIMA/2. Semester Study/2. WS2425/4. W24 Web Data Integration/Project/v2/UMA_Web_Data_Integation/LLM_Gold_Standard/output/apple_merged_llm.csv")
