...
data_dir = project_root / 'LLM_Gold_Standard'

# Read CSV files
df_apple = pd.read_csv(data_dir / 'output/apple_opendb_sampled_1000_v2.csv', header=None)
df_million = pd.read_csv(data_dir / 'output/million_opendb_sampled_1000_v2.csv', header=None)

# Rename specific columns from the source CSVs
df_apple = df_apple[[0, 1, 9]].rename(columns={
    0: 'o_apple_key',
    1: 'o_opendb_key', 
    9: 'o_flag'
})
df_million = df_million[[0, 1, 9]].rename(columns={
    0: 'm_million_key',
    1: 'm_opendb_key',
    9: 'm_flag'
})
...
try:
    # Read XML files
    xml_dir = Path('/Users/anhnhat/Library/Mobile Documents/com~apple~CloudDocs/Documents/UNIMA/2. Semester Study/2. WS2425/4. W24 Web Data Integration/Project/v2/UMA_Web_Data_Integation/data/input')
    ...
    apple_output =  '/Users/anhnhat/Library/Mobile Documents/com~apple~CloudDocs/Documents/UNIMA/2. Semester Study/2. WS2425/4. W24 Web Data Integration/Project/v2/UMA_Web_Data_Integation/LLM_Gold_Standard/output/apple_merged.csv'
    df_apple_merged.to_csv(apple_output, index=False)
    
    # Save Million merged dataset
    million_output = '/Users/anhnhat/Library/Mobile Documents/com~apple~CloudDocs/Documents/UNIMA/2. Semester Study/2. WS2425/4. W24 Web Data Integration/Project/v2/UMA_Web_Data_Integation/LLM_Gold_Standard/output/million_merged.csv'
