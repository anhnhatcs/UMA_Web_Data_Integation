...
class MusicMatcher:
    ...
    def compare_tracks(self, row: Dict) -> Dict:
        try:
            ...
            Data to compare:
            million_Artist: {row['million_Artist']} vs opendb_Artist: {row['opendb_Artist']}
            million_Track: {row['million_Track']} vs opendb_Track: {row['opendb_Track']}
            million_Year: {row['million_Album_Year']} vs opendb_Year: {row['opendb_Album_Year']}
            million_Duration: {row['million_Duration']} vs opendb_Duration: {row['opendb_Duration']}
            ...
            5. If the music have name with some suffix but perform by different artist or in different song, they will be mark as not same.
...
if __name__ == "__main__":
    # Test file path
    file_path = "/Users/anhnhat/Library/Mobile Documents/com~apple~CloudDocs/Documents/UNIMA/2. Semester Study/2. WS2425/4. W24 Web Data Integration/Project/v2/UMA_Web_Data_Integation/LLM_Gold_Standard/output/million_merged.csv"
    ...
    # Save all results
    matcher.save_results("/Users/anhnhat/Library/Mobile Documents/com~apple~CloudDocs/Documents/UNIMA/2. Semester Study/2. WS2425/4. W24 Web Data Integration/Project/v2/UMA_Web_Data_Integation/LLM_Gold_Standard/output/million_merged_llm.csv")
