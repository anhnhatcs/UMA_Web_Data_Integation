...
# Process both files
million_input = base_path / 'million_opendb_similarities_20241117_012633.csv'
million_output = base_path / 'million_opendb_sampled_1000.csv'
sample_and_save(million_input, million_output)

apple_input = base_path / 'apple_opendb_similarities_20241117_012633.csv'
apple_output = base_path / 'apple_opendb_sampled_1000.csv'
